...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_search_field('identifier_ssi') do |field|
      # solr_parameters hash are sent to Solr as ordinary url query params.
      field.solr_parameters = {
        'spellcheck.dictionary': 'identifier_ssi',
        qf: '${identifier_ssi_qf}',
        pf: '${identifier_ssi_pf}'
      }
    end
    ...
    config.add_sort_field 'score desc, date_ssim desc, title_tsim asc', label: 'relevance'
    config.add_sort_field 'date_ssim desc, title_tsim asc', label: 'year'
    config.add_sort_field 'creator_ssim asc, title_tsim asc', label: 'author'
